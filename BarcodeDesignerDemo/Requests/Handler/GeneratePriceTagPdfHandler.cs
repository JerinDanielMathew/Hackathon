...
{
    public class GeneratePriceTagPdfHandler
    {
        public MemoryStream Handle(GeneratePriceTagPdfCommand command)
        {
            ...
            {
                DrawObject(gfx, obj, command.FieldValues, imageStreams);
            }
